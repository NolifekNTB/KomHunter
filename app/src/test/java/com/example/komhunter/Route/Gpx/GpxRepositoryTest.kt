...
class GpxRepositoryTest {
    ...
    @Test
    fun `test insertAll calls gpxDao insertAll`() = runBlocking {
        // Given
    ...
    @Test
    fun `test getAllCoordinates returns flow of coordinates`() = runBlocking {
        // Given
        val coordinates = listOf(
            GpxCoordinate(latitude = 40.7128, longitude = -74.0060, elevation = 10.0),
            GpxCoordinate(latitude = 34.0522, longitude = -118.2437, elevation = 15.0)
    ...
    @Test
    fun `test deleteAll calls gpxDao deleteAll`() = runBlocking {
        // Given
